    ...
    const onSubmit = async (data: any) => {
        ...
        try {
            ...
            if (response.status === 200) {
                const emailChangeResponse = await api.put('/v2/user/change-email', updateData);
        ...
        <div className="bg-[#F2EBF9] rounded-[12px] h-auto">
            <div className="p-[40px]">
                <div className="max-w-[424px] mx-auto text-center">
                    <h2 className="text-[#444444] font-medium text-[32px] leading-[38px]">Verify your email</h2>
